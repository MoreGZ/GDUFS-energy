...
export default {
	...
	methods:{
		...
		fetchData:function(page){
			...
			this.$ajax.post("http://121.42.203.85/energycenter/public/api/admin/showSimplePushes",formData)
			.then((response)=>{
		...
		fetchSearchData:function(){
			...
			this.$ajax.post("http://121.42.203.85/energycenter/public/api/admin/searchPush",formData)
			.then((response)=>{
				if(response.data.re == 0){
