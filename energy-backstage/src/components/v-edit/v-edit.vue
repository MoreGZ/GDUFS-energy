...
export default {
	...
	methods:{
		fetchData:function(id){
			...
			this.$ajax.post("http://121.42.203.85/energycenter/public/api/admin/showDetailPush", formData)
			.then((response)=>{
		...
		sendImg:function(data){
			...
			this.$ajax.post("http://121.42.203.85/energycenter/public/api/admin/uploadImageForUrl",formData)
			.then((response)=>{
				if(response.data.re == 0){
